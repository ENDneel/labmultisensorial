    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RecomendacionEst', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Recomendacion.RecomendacionEst', verbose_name='RecomendacionEst')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AC41', models.PositiveIntegerField(verbose_name='Dos actividades')),
                ('AC42', models.PositiveIntegerField(verbose_name='Juegos serios con lápiz- libre - dos')),
                ('RecomendacionEst', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Recomendacion.RecomendacionEst', verbose_name='Recomendacion Est')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AC41', models.PositiveIntegerField(verbose_name='Dos actividades')),
                ('AC42', models.PositiveIntegerField(verbose_name='Juegos serios con lápiz- libre - dos')),
                ('RecomendacionEst', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Recomendacion.RecomendacionEst', verbose_name='Estudiante')),
            ],
            options={
